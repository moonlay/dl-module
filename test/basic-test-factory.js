...
function getBasicTest(opt) {
    ...
    it("#05. should error when create new data with same key(s)", function (done) {
    ...
    it("#08. should error when update new data with same key(s)", function (done) {
        if (keys.length <= 0)
            this.skip();
        else {
            var newDataId;
    ...
    it("#12. should success when destroy data with id", function (done) {
    ...
    it(`#13. should null when get destroyed data`, function (done) {
