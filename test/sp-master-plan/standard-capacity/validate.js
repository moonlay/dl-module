...
// it("#03. should error when create new data with SH Cutting 0, SH Sp 0, SH Finishing 0", function (done) {
//     dataUtil.getNewData()
//         .then((data) => {
//             data.shCutting = 0;
//             data.shSp = 0;
...
//                     e.errors.should.have.property("shSp");
...
it("#04. should error when create new data with SH Cutting 0, SH Sp 0, SH Finishing 0", function (done) {
    dataUtil.getNewData()
        .then((data) => {
            data.shCutting = 0;
            data.shSp = 0;
...
//     dataUtil.getNewData()
//         .then((data) => {
//             data.spBuyerId=createdData.spBuyerId;
