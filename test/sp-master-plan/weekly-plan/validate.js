...
var Manager = require("../../../src/managers/sp-master-plan/weekly-plan-manager");
var manager = null;
var dataUtil = require("../../data-util/sp-master-plan/weekly-plan-data-util");
var validate = require("dl-models").validator.spMasterPlan.weeklyPlan;
...
// it("#05. should error when create new data with invalid efficiency, operator and workingCapacities", function (done) {
//     dataUtil.getNewData()
//         .then((data) => {
//             data.items[0].efficiency = 0;
//             data.items[0].operator = 0;
//             data.items[0].workingCapacities = 0;
//             manager.create(data)
//                 .then((id) => {
//                     done("should error when create new data with invalid efficiency, operator and workingCapacities");
//                 })
//                 .catch((e) => {
//                     e.name.should.equal("ValidationError");
//                     e.should.have.property("errors");
...
//                             item.should.have.property('workingCapacities');
//                         }
//                     }
//                     done();
//                 });
