...
var Manager = require("../../../src/managers/sp-master-plan/booking-order-manager");
var manager = null;
var dataUtil =require("../../data-util/sp-master-plan/booking-order-data-util");
var validate = require("dl-models").validator.spMasterPlan.bookingOrder;


var ManagerPlan = require("../../../src/managers/sp-master-plan/sp-blocking-plan-manager");
var managerPlan = null;
var dataUtilPlan =require("../../data-util/sp-master-plan/sp-blocking-plan-data-util");
var validatePlan = require("dl-models").validator.spMasterPlan.masterPlan;
...
it("#09. should success when search data with filter", function (done) {
    manager.read({
        keyword: createdData.spBuyerName
    })
        .then((documents) => {
            //process documents
