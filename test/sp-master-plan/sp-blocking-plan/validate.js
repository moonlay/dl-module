...
var Manager = require("../../../src/managers/sp-master-plan/sp-blocking-plan-manager");
var manager = null;
var dataUtil =require("../../data-util/sp-master-plan/sp-blocking-plan-data-util");
var validate = require("dl-models").validator.spMasterPlan.spBlockingPlan;
...
it("#05. should error when create new data with 0 value on  shSp and quantity", function (done) {
    dataUtil.getNewData()
        .then((data) => {
            //data.details[0].shCutting = 0;
            data.details[0].shSp = 0;
            //data.details[0].shFinishing = 0;
            data.details[0].quantity = 0;
            manager.create(data)
                .then((id) => {
                    done("should error when create new data with 0 value on  shSp and quantity");
                })
                .catch((e) => {
                    e.name.should.equal("ValidationError");
                    e.should.have.property("errors");
                    ...
                    e.errors.details[0].should.have.property("shSp");
