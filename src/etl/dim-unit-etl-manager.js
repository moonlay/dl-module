                ...
                .then(() => {
                    ...
                    transaction.begin((err) => {
                        ...
                        for (var item of data) {
                            if (item) {
                                var queryString = `insert into DL_Dim_Unit_Temp(ID_dim_unit, Kode_unit, Nama_Divisi, Nama_unit) values(${count}, '${item.unitCode}', '${item.divisionName}', '${item.unitName}');\n`;
                        ...
                        return Promise.all(command)
                            .then((results) => {
                                request.execute("DL_UPSERT_DIM_UNIT").then((execResult) => {
