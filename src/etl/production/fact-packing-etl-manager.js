            ...
            if (packing) {
                ...
                var packingData = packing.items.map((packingItem) => {
                    return {
                        ...
                        designCode: packing.designCode ? `'${packing.designCode}'` : null,
                        designNumber: packing.designNumber ? `'${packing.designNumber}'` : null,
                        buyerId: packing.buyerId ? `'${packing.buyerId}'` : null,
                        buyerCode: packing.buyerCode ? `'${packing.buyerCode}'` : null,
                        buyerName: packing.buyerName ? `'${packing.buyerName}'` : null,
                        buyerAddress: packing.buyerAddress ? `'${packing.buyerAddress}'` : null,
                        ...
                        colorCode: packing.colorCode ? `'${packing.colorCode}'` : null,
                        colorName: packing.colorName ? `'${packing.colorName}'` : null,
                        colorType: packing.colorType ? `'${packing.colorType}'` : null,
                        materialConstructionFinishId: packing.materialConstructionFinishId ? `'${packing.materialConstructionFinishId}'` : null,
                        materialConstructionFinishName: packing.materialConstructionFinishName ? `'${packing.materialConstructionFinishName}'` : null,
                        materialId: packing.materialId ? `'${packing.materialId}'` : null,
                        material: packing.material ? `'${packing.material}'` : null,
                        materialWidthFinish: packing.materialWidthFinish ? `'${packing.materialWidthFinish}'` : null,
                        construction: packing.construction ? `'${packing.construction}'` : null,
                        deliveryType: packing.deliveryType ? `'${packing.deliveryType}'` : null,
                        finishedProductType: packing.finishedProductType ? `'${packing.finishedProductType}'` : null,
                        motif: packing.motif ? `'${packing.motif}'` : null,
                        lot: packingItem.lot ? `'${packingItem.lot}'` : null,
                        grade: packingItem.grade ? `'${packingItem.grade}'` : null,
                        ...
                        remark: packingItem.remark ? `'${packingItem.remark}'` : null,
                        status: packing.status ? `'${packing.status}'` : null,
