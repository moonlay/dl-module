...
module.exports = class ProductionOrderManager extends BaseManager {
    ...
    _beforeInsert(productionOrder) {
        if (!productionOrder.orderNo) {
            ...
            if (productionOrder.orderType.name.toString().toLowerCase() === "printing") {
               type = "P";
            } else if (productionOrder.orderType.name.toString().toLowerCase() === "rfp") {
                type = "RFP";
            } else if (productionOrder.orderType.name.toString().toLowerCase() === "rfd") {
                type = "RFD";
            } else {
                type = "F";
            }
