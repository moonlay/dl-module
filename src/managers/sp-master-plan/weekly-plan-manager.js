...
var WeeklyPlan = DLModels.spMasterPlan.WeeklyPlan;
var WeeklyPlanItem = DLModels.spMasterPlan.WeeklyPlanItem;
...
module.exports = class WeeklyPlanManager extends BaseManager {
    constructor(db, user) {
        super(db, user);
        this.collection = this.db.use(map.spMasterPlan.collection.WeeklyPlan);
    ...
    _createIndexes() {
        var dateIndex = {
            name: `ix_${map.spMasterPlan.collection.WeeklyPlan}__updatedDate`,
            key: {
                _updatedDate: -1
            }
        };
        ...
        var uearIndex = {
            name: `ix_${map.spMasterPlan.collection.WeeklyPlan}_year_unitId`,
            key: {
                "year": 1,
                "unitId": 1,
            }
