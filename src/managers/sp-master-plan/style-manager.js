...
var Style = DLModels.spMasterPlan.Style;
...
module.exports = class StyleManager extends BaseManager {
    constructor(db, user) {
        super(db, user);
        this.collection = this.db.use(map.spMasterPlan.collection.Style);
    }
    ...
    _createIndexes() {
        var dateIndex = {
            name: `ix_${map.spMasterPlan.collection.Style}__updatedDate`,
            key: {
                _updatedDate: -1
            }
        };
        ...
        var codeIndex = {
            name: `ix_${map.spMasterPlan.collection.Style}_code`,
            key: {
                "code": 1
            }
        };
