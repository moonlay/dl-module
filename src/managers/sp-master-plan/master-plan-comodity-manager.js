...
var MasterPlanComodity = DLModels.spMasterPlan.MasterPlanComodity;
...
module.exports = class MasterPlanComodityManager extends BaseManager {
    constructor(db, user) {
        super(db, user);
        this.collection = this.db.use(map.spMasterPlan.collection.MasterPlanComodity);
    }
    ...
    _createIndexes() {
        var dateIndex = {
            name: `ix_${map.spMasterPlan.collection.MasterPlanComodity}__updatedDate`,
            key: {
                _updatedDate: -1
            }
        };
        ...
        var codeIndex = {
            name: `ix_${map.spMasterPlan.collection.MasterPlanComodity}_code`,
            key: {
                "code": 1
            }
        };
