            ...
            .then((results) => {
                ...
                if (valid.items && valid.items.length <= 0) {
                    ...
                    valid.items.forEach((item, index) => {
                        ...
                        var existSecondUom = _uoms.find((uom) => uom._id.toString() === item.secondUomId.toString());
                        var existThirdUom = _uoms.find((uom) => uom._id.toString() === item.thirdUomId.toString());
